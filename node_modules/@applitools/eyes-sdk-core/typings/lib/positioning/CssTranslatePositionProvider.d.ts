...
declare const CssTranslatePositionProvider_base: typeof import("./PositionProvider");
/**
 ...
 * @template TSelector
 */
declare class CssTranslatePositionProvider<TDriver, TElement, TSelector> extends CssTranslatePositionProvider_base {
    /**
     ...
     */
    constructor(logger: any, executor: import("../wrappers/EyesJsExecutor")<TDriver, TElement, TSelector>, scrollRootElement?: import("../wrappers/EyesWrappedElement")<TDriver, TElement, TSelector>);
    _logger: any;
    _executor: import("../wrappers/EyesJsExecutor")<TDriver, TElement, TSelector>;
...
declare namespace CssTranslatePositionProvider {
