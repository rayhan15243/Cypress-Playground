  ...
  */
  ...
  (function (factory) {
    ...
    var AbortSignal = /*#__PURE__*/function (_Emitter) {
      _inherits$$1(AbortSignal, _Emitter);

      function AbortSignal() {
        var _this2;

        _classCallCheck$$1(this, AbortSignal);

        _this2 = _possibleConstructorReturn$$1(this, _getPrototypeOf$$1(AbortSignal).call(this)); // Some versions of babel does not transpile super() correctly for IE <= 10, if the parent
        ...
        if (!_this2.listeners) {
          Emitter.call(_assertThisInitialized$$1(_this2));
        } // Compared to assignment, Object.defineProperty makes properties non-enumerable by default and
        // we want Object.keys(new AbortController().signal) to be [] for compat with the native impl


        Object.defineProperty(_assertThisInitialized$$1(_this2), 'aborted', {
          value: false,
          writable: true,
          configurable: true
        });
        Object.defineProperty(_assertThisInitialized$$1(_this2), 'onabort', {
          value: null,
          writable: true,
          configurable: true
        });
      ...
      _createClass$$1(AbortSignal, [{
        ...
        value: function dispatchEvent(event) {
          ...
          _get$$1(_getPrototypeOf$$1(AbortSignal.prototype), "dispatchEvent", this).call(this, event);
        }
      }]);
    ...
    var AbortController = /*#__PURE__*/function () {
      function AbortController() {
        _classCallCheck$$1(this, AbortController); // Compared to assignment, Object.defineProperty makes properties non-enumerable by default and
      ...
      _createClass$$1(AbortController, [{
        key: "abort",
  ...
  var styleProps = ['background-repeat', 'background-origin', 'background-position', 'background-color', 'background-image', 'background-size', 'border-width', 'border-color', 'border-style', 'color', 'display', 'font-size', 'font-weight', 'line-height', 'margin', 'opacity', 'overflow', 'padding', 'visibility'];
  ...
  function _getImageSizes() {
    _getImageSizes = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              return _context.abrupt("return", _context.sent.reduce(function (images, curr) {
                if (curr) {
                  images[curr.url] = {
                    width: curr.width,
                    height: curr.height
      ...
      try {
        ...
        for (var _i = 0, _Array$from = Array.from(styleSheet.cssRules); _i < _Array$from.length; _i++) {
          ...
          if (rule instanceof CSSImportRule) {
            var nestedUrl = absolutizeUrl(rule.href, styleBaseUrl);
        ...
        console.log("error during getBundledCssFromCssText, styleBaseUrl=".concat(styleBaseUrl), ex);
      }

      bundledCss = "".concat(bundledCss).concat(getCss(cssText, styleBaseUrl));
      return {
  ...
  function makeFetchCss(fetch) {
    ...
    return /*#__PURE__*/function () {
      var _fetchCss = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
              ...
              case 0:
                ...
                if (!Number.isNaN(Number(fetchTimeLimit))) {
                  result.push(new Promise(function (resolve) {
                    return setTimeout(resolve, fetchTimeLimit);
                  }).then(function () {
                    return controller.abort();
                  }));
                }

                return _context.abrupt("return", Promise.race(result));
  ...
  var isLinkToStyleSheet = function isLinkToStyleSheet(node) {
    if (node.nodeName && node.nodeName.toUpperCase() === 'LINK' && node.attributes) {
      var attributes = new Map(Array.from(node.attributes, function (attr) {
        return [attr.name.toLowerCase(), attr.value.toLowerCase()];
      }));
      return attributes.get('rel') === 'stylesheet' || attributes.get('as') === 'style' && ['preload', 'prefetch'].includes(attributes.get('rel'));
    } else {
      return false;
    }
  };
  ...
  function makeExtractCssFromNode(_ref) {
    ...
    return function extractCssFromNode(node, baseUrl) {
      var cssText, styleBaseUrl, isUnfetched;
  ...
  function makeCaptureNodeCss(_ref) {
    ...
    return function captureNodeCss(node, baseUrl) {
      var _extractCssFromNode = extractCssFromNode(node, baseUrl),
          styleBaseUrl = _extractCssFromNode.styleBaseUrl,
      ...
      if (cssText) {
        var _getBundledCssFromCss = getBundledCssFromCssText(cssText, styleBaseUrl),
        ...
        bundledCss += "".concat(unfetchedToken).concat(styleBaseUrl).concat(unfetchedToken);
  ...
  function makePrefetchAllCss(fetchCss) {
    return /*#__PURE__*/function () {
      var _prefetchAllCss = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var doc,
            cssMap,
            start,
            promises,
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                doFetchAllCssFromFrame = function _doFetchAllCssFromFra(frameDoc, baseUrl, cssMap, promises) {
                  ...
                  function _fetchAllCssFromElement() {
                    _fetchAllCssFromElement = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el) {
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                  ...
                  function _fetchAllCssFromIframe() {
                    _fetchAllCssFromIframe = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(el) {
                      var _baseUrl;
                      ...
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                              try {
                                _baseUrl = isInlineFrame_1(el) ? el.baseURI : el.contentDocument.location.href;
                                doFetchAllCssFromFrame(el.contentDocument, _baseUrl, cssMap, promises);
                              } catch (ex) {
                                console.log(ex);
                              }
                ...
                _fetchBundledCss = function _fetchBundledCss3() {
                  _fetchBundledCss = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(cssText, resourceUrl, cssMap) {
                        ...
                        switch (_context5.prev = _context5.next) {
                          case 0:
                            ...
                            _loop = function _loop() {
                              ...
                              if (rule instanceof CSSImportRule) {
                                _promises.push(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                ...
                fetchBundledCss = function _fetchBundledCss2(_x4, _x5, _x6) {
                  return _fetchBundledCss.apply(this, arguments);
                };

                _fetchNodeCss = function _fetchNodeCss3() {
                  _fetchNodeCss = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(node, baseUrl, cssMap) {
                ...
                fetchNodeCss = function _fetchNodeCss2(_x, _x2, _x3) {
                  return _fetchNodeCss.apply(this, arguments);
                };
  ...
  function _captureFrame() {
    _captureFrame = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var _ref,
          styleProps,
          rectProps,
          ignoredTagNames,
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              doCaptureDoc = function _doCaptureDoc(docFrag) {
                var baseUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : docFrag.location && docFrag.location.href;
                var bgImages = new Set();
                var bundledCss = '';
                var ret = captureNode(docFrag.documentElement || docFrag);
                ret.css = bundledCss;
                ...
                function captureNode(node) {
                  var _captureNodeCss = captureNodeCss$$1(node, baseUrl),
                  ...
                  if (nodeUnfetched) {
                    var _iterator = _createForOfIteratorHelper(nodeUnfetched),
                        _step;
                ...
                function elementToJSON(el) {
                  var childNodes = Array.prototype.map.call(el.childNodes, captureNode).filter(Boolean);
                  var shadowRoot = el.shadowRoot && doCaptureDoc(el.shadowRoot, baseUrl);
                  ...
                  var _iterator2 = _createForOfIteratorHelper(styleProps),
                      _step2;
                  ...
                  var _iterator3 = _createForOfIteratorHelper(rectProps),
                      _step3;
              ...
              captureTextNode = function _captureTextNode(node) {
                return {
                  tagName: '#text',
              ...
              notEmptyObj = function _notEmptyObj(obj) {
                return Object.keys(obj).length ? obj : undefined;
              };

              stats = function _stats() {
                if (!addStats) {
                  return '';
                }
              ...
              endTime = function _endTime(obj) {
                obj.endTime = Date.now();
                obj.elapsedTime = obj.endTime - obj.startTime;
              };

              startTime = function _startTime(obj) {
              ...
              fetchTimeLimit = _args.length > 3 && _args[3] !== undefined ? _args[3] : 30000;
              performance = {
                total: {},
                prefetchCss: {},
                doCaptureDoc: {},
            ...
            case 22:
              ...
              capturedFrame = doCaptureDoc(doc);
  ...
  return captureDomForIE.apply(this, arguments);
}